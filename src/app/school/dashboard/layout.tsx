...
const menuItems = [
  { href: '/school/dashboard', label: 'School Dashboard', icon: <Home /> },
  { href: '/school/dashboard/students', label: 'Students', icon: <GraduationCap /> },
  { href: '/school/dashboard/messages', label: 'Messages', icon: <MessageSquare /> },
];
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                asChild
                tooltip="Settings"
                isActive={pathname === '/school/dashboard/settings'}
              >
                <Link href="/school/dashboard/settings">
                  <Settings />
                  <span>Settings</span>
                </Link>
              </SidebarMenuButton>
